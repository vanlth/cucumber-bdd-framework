...
public class BasePageUIs {
	public static final String CUSTOM_INFOR_LINK ="xpath=//div[contains(@class,'account-navigation')]//a[text()='Customer info']";
	...
	public static final String LOGOUT_LINK_AT_USER_PAGE = "xpath=//a[@class='ico-account']";
